...
public class FusionErrorUI : MonoBehaviour {
    ...
    private static (string, string) ShutdownReasonToHuman(ShutdownReason shutdownReason) {
        return shutdownReason switch {
            ...
            ShutdownReason.InvalidAuthentication => ("Authentication Failed", "We failed to authenticate your client! Please restart your game with steam open"),
            ShutdownReason.CustomAuthenticationFailed => ("Authentication Failed", "We failed to authenticate your client! Please restart your game with steam open"),
